# Expected Symptom: padding_included_in_ce

- **What was broken**: Injected bug `padding_included_in_ce`.
...
- **Prevention Test**: `tests/test_bug_injections.py::test_bug_padding_included_in_ce`
