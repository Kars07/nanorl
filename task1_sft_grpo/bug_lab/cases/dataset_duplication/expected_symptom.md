# Expected Symptom: dataset_duplication

- **What was broken**: Injected bug `dataset_duplication`.
...
- **Prevention Test**: `tests/test_bug_injections.py::test_bug_dataset_duplication`
