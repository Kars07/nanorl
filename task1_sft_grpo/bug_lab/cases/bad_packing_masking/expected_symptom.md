# Expected Symptom: bad_packing_masking

- **What was broken**: Injected bug `bad_packing_masking`.
...
- **Prevention Test**: `tests/test_bug_injections.py::test_bug_bad_packing_masking`
