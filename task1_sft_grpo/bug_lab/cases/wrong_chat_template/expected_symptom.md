# Expected Symptom: wrong_chat_template

- **What was broken**: Injected bug `wrong_chat_template`.
...
- **Prevention Test**: `tests/test_bug_injections.py::test_bug_wrong_chat_template`
